...
class Escoba(Modelo):
    ...
    def __init__(self):
        super().__init__(0.0,-0.8,0.0,1.0,0.0)
    ...
    def dibujar(self):
        ...
        glScalef(self.scale,self.scale,0.0)
        ...
        glVertex3f(0.015, 0.02,0)
        glVertex3f(-0.015, 0.02,0)
        glVertex3f(-0.015, 0.01,0)
        glVertex3f(0.015, 0.01,0)
        glEnd()

        glBegin(GL_QUADS)
        glColor3f(0.9,0.9,0.9)
        glVertex3f(0.015*0.6, 0.02,0)
        glVertex3f(-0.015*0.6, 0.02,0)
        glVertex3f(-0.015*0.6, 0.015,0)
        glVertex3f(0.015*0.6, 0.015,0)
        glEnd()
        
        glBegin(GL_QUADS)
        glColor3f(0.59,0.29,0.00)
        glVertex3f(-0.005, 0.01,0)
        glVertex3f(-0.005, -0.02,0)
        glVertex3f(0.005, -0.02,0)
        glVertex3f(0.005, 0.01,0)
        glEnd()
        glPopMatrix()
